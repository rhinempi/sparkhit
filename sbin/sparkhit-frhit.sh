...
time $sparkbin/spark-submit \
	...
	$sparkhitlib/original-sparkhit-0.7.jar \
		...
		-linetofa \
		-tool $sparkhitpackage/pipe-frhit.sh \
		-toolparam " -d /mnt/reference/sparkhit/reference.fa -T 2" \
		-outfile /mnt/sparkhit/frhit \
		-partition 1600 \
		> sparkhit-sparkhitfrhit.log 2> sparkhit-sparkhitfrhit.err
