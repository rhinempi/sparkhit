...
time $sparkbin/spark-submit \
	...
	--driver-memory 2G \
	--executor-memory 4G \
	--class uni.bielefeld.cmg.sparkhit.main.MainOfReducer \
	$sparkhitlib/original-sparkhit-0.8.jar \
		-vcf /mnt/HMP/line/*.vcf \
		-outfile /mnt/sparkhit/pca_result \
		-partition 1600 \
		> sparkhit-pac.log 2> sparkhit-pca.err
