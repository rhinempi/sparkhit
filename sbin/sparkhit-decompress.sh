...
time $sparkbin/spark-submit \
	...
	--driver-memory 15G \
	--executor-memory 57G \
	--class uni.bielefeld.cmg.sparkhit.main.MainOfDecompresser \
	$sparkhitlib/original-sparkhit-0.7.jar \
		-fastq file:/mnt/ftpdownload/*.bz2 \
		-outfile /mnt/sparkhit/decompress \
		> sparkhit-decompress.log 2> sparkhit-decompress.err
