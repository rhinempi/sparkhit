...
time $sparkbin/spark-submit \
	...
	$sparkhitlib/original-sparkhit-0.7.jar \
		...
		-tool $sparkhitpackage/pipe-bowtie2.sh \
		-toolparam " -q -x /mnt/reference/bowtie2/reference.fa " \
		-outfile /mnt/sparkhit/bowtie2 \
		-partition 1600 \
		> sparkhit-bowtie2.log 2> sparkhit-bowtie2.err
