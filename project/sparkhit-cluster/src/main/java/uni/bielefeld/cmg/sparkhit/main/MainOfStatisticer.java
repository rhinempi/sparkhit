...
import uni.bielefeld.cmg.sparkhit.util.ParameterForStatisticer;
 ...
 * Sparkhit-statisticer. It can also be specified at the input options
 ...
 * @see
 */
public class MainOfStatisticer {
    /**
    ...
    public static void main(String[] args){
        ...
        info.readParagraphedMessages("SparkHit HWE test initiating ... \ninterpreting parameters.");
        info.screenDump();
