...
import uni.bielefeld.cmg.sparkhit.util.ParameterForMapper;
 ...
 * Sparkhit-mapper. It can also be specified at the input options
...
public class MainOfMapper {
    ...
    public static void main(String[] args){
        ...
        info.readParagraphedMessages("SparkHit mapper initiating ... \ninterpreting parameters.");
        info.screenDump();

        ParameterForMapper parameter = null;
        try {
            parameter = new ParameterForMapper(args);
        } catch (IOException e) {
            e.fillInStackTrace();
