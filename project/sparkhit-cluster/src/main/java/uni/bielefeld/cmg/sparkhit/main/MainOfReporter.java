...
import uni.bielefeld.cmg.sparkhit.util.ParameterForReporter;
 ...
 * Sparkhit-reporter. It can also be specified at the input options
...
public class MainOfReporter {
    ...
    public static void main(String[] args){
        ...
        info.readParagraphedMessages("SparkHit Reporter initiating ... \ninterpreting parameters.");
        info.screenDump();

        ParameterForReporter parameterR = null;
        try {
            parameterR = new ParameterForReporter(args);
        } catch (IOException e) {
            e.fillInStackTrace();
