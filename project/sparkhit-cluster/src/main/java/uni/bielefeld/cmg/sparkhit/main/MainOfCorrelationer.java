...
import uni.bielefeld.cmg.sparkhit.util.ParameterForCorrelationer;
 ...
 * Sparkhit-correlationer. It can also be specified at the input options
 ...
 * @see
 */
public class MainOfCorrelationer {
    /**
    ...
    public static void main(String[] args){
        ...
        info.readParagraphedMessages("SparkHit Correlationer initiating ... \ninterpreting parameters.");
        info.screenDump();

        ParameterForCorrelationer parameterC = null;
        try {
            parameterC = new ParameterForCorrelationer(args);
        } catch (IOException e) {
            e.fillInStackTrace();
