...
import uni.bielefeld.cmg.sparkhit.util.ParameterForConverter;
 ...
 * Sparkhit-converter. It can also be specified at the input options
...
public class MainOfConverter {
    ...
    public static void main(String[] args){
        ...
        info.readParagraphedMessages("SparkHit Converter initiating ... \ninterpreting parameters.");
        info.screenDump();

        ParameterForConverter parameterC = null;
        try {
            parameterC = new ParameterForConverter(args);
        } catch (IOException e) {
            e.fillInStackTrace();
