...
import uni.bielefeld.cmg.sparkhit.util.ParameterForRegressioner;
...
public class MainOfRegressioner {
    public static void main(String[] args){
        ...
        ParameterForRegressioner parameterR = null;
        try {
            parameterR = new ParameterForRegressioner(args);
        } catch (IOException e) {
            e.fillInStackTrace();
